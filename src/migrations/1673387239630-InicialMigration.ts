...
export class InicialMigration1673387239630 implements MigrationInterface {
    name = 'InicialMigration1673387239630'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "medicine" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "class" character varying(70) NOT NULL, "description" character varying NOT NULL, "animalsId" uuid, "treatmentId" uuid, CONSTRAINT "PK_b9e0e6f37b7cadb5f402390928b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "animals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(70) NOT NULL, "weigth" character varying NOT NULL, "size" character varying NOT NULL, "birth_date" date NOT NULL, "first_visit" TIMESTAMP NOT NULL DEFAULT now(), "last_visit" TIMESTAMP NOT NULL DEFAULT now(), "typeId" uuid, "ownerIdId" uuid, CONSTRAINT "PK_6154c334bbb19186788468bce5c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "consults" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "hour" TIME NOT NULL, "animalId" uuid, "doctorIdId" uuid, "treatmentIdId" uuid, CONSTRAINT "REL_336c68a581a7dc3f29f0d86be8" UNIQUE ("treatmentIdId"), CONSTRAINT "PK_f1dfb48f1617b7b774fd4da7a97" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "medicine" ADD CONSTRAINT "FK_b26a19309618798f40eeda01b75" FOREIGN KEY ("animalsId") REFERENCES "animals"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "consults" ADD CONSTRAINT "FK_cfe071a5f6653e0418e7d1f4a88" FOREIGN KEY ("doctorIdId") REFERENCES "doctors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "consults" ADD CONSTRAINT "FK_336c68a581a7dc3f29f0d86be8a" FOREIGN KEY ("treatmentIdId") REFERENCES "treatment"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "consults" DROP CONSTRAINT "FK_336c68a581a7dc3f29f0d86be8a"`);
        await queryRunner.query(`ALTER TABLE "consults" DROP CONSTRAINT "FK_cfe071a5f6653e0418e7d1f4a88"`);
        ...
        await queryRunner.query(`ALTER TABLE "medicine" DROP CONSTRAINT "FK_b26a19309618798f40eeda01b75"`);
