...
export class InitialMigration1673355825265 implements MigrationInterface {
    name = 'InitialMigration1673355825265'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "doctors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(70) NOT NULL, "email" character varying(70) NOT NULL, "password" character varying(120) NOT NULL, "crmmv" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, CONSTRAINT "UQ_62069f52ebba471c91de5d59d61" UNIQUE ("email"), CONSTRAINT "REL_ad816aa66aa42fad408b1b7d76" UNIQUE ("addressId"), CONSTRAINT "PK_8207e7889b50ee3695c2b8154ff" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "animals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(70) NOT NULL, "email" character varying(70) NOT NULL, "password" character varying(120) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "vaccinesId" uuid, "addressId" uuid, "ownerIdId" uuid, CONSTRAINT "UQ_5982aadf1c7dfeead70dc6b33b0" UNIQUE ("email"), CONSTRAINT "REL_5f8ab35ed46bd2706566534201" UNIQUE ("addressId"), CONSTRAINT "PK_6154c334bbb19186788468bce5c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "animals" ADD CONSTRAINT "FK_5f8ab35ed46bd27065665342010" FOREIGN KEY ("addressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "animals" DROP CONSTRAINT "FK_5f8ab35ed46bd27065665342010"`);
