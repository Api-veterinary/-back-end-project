...
export class InicialMigration1673488864455 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vaccine_aplication_vaccine_medicine" ("vaccineAplicationId" uuid NOT NULL, "medicineId" uuid NOT NULL, CONSTRAINT "PK_012292d8adf893ee35c8a6c591a" PRIMARY KEY ("vaccineAplicationId", "medicineId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_203d89e5672945b85e26ae0d8e" ON "vaccine_aplication_vaccine_medicine" ("vaccineAplicationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a2725e35f0887e45a8dfdd2d7c" ON "vaccine_aplication_vaccine_medicine" ("medicineId") `);
        ...
        await queryRunner.query(`ALTER TABLE "vaccine_aplication_vaccine_medicine" ADD CONSTRAINT "FK_203d89e5672945b85e26ae0d8ef" FOREIGN KEY ("vaccineAplicationId") REFERENCES "vaccine_aplication"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "vaccine_aplication_vaccine_medicine" ADD CONSTRAINT "FK_a2725e35f0887e45a8dfdd2d7c6" FOREIGN KEY ("medicineId") REFERENCES "medicine"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vaccine_aplication_vaccine_medicine" DROP CONSTRAINT "FK_a2725e35f0887e45a8dfdd2d7c6"`);
        await queryRunner.query(`ALTER TABLE "vaccine_aplication_vaccine_medicine" DROP CONSTRAINT "FK_203d89e5672945b85e26ae0d8ef"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a2725e35f0887e45a8dfdd2d7c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_203d89e5672945b85e26ae0d8e"`);
