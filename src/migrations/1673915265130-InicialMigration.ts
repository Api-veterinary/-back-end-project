...
export class InicialMigration1673915265130 implements MigrationInterface {
    name = 'InicialMigration1673915265130'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "animals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(70) NOT NULL, "weight" character varying NOT NULL, "birth_date" date NOT NULL, "first_visit" TIMESTAMP NOT NULL DEFAULT now(), "last_visit" TIMESTAMP NOT NULL DEFAULT now(), "delete_date" TIMESTAMP, "sizeId" uuid, "typeId" uuid, "ownerId" uuid, CONSTRAINT "PK_6154c334bbb19186788468bce5c" PRIMARY KEY ("id"))`);
